...
# Create an engine instance using the dynamic database URL
database_url = f"mysql+pymysql://{os.getenv('MYSQL_USER')}:{os.getenv('MYSQL_PASSWORD')}@{os.getenv('CLOUD_SERVICE_IP')}/{os.getenv('MYSQL_DATABASE')}"
