...
const Setting = () => {
    ...
    const { data: fetchedSetting } = useSWR<FormValues>(
        `setting-detail-${sensorId}`,
        () => SettingAPI.fetchSetting(sensorId),
    )
    ...
    return (
        <Box m="20px">
            ...
            <Formik onSubmit={handleSubmit} initialValues={settingValues} enableReinitialize>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        >
                            {sensorSettings[sensorId]?.options.map((option) => (
                                <Box key={option.name}>
                                    <Typography variant="h2" fontWeight="600" color={colors.grey[100]} marginBottom="25px">
                                    ...
                                    <Slider
                                        ...
                                        onChange={(e, val) => setFieldValue(`min_${option.name}`, val)}
                                    ...
                                    <Slider
                                        ...
                                        onChange={(e, val) => setFieldValue(`max_${option.name}`, val)}
